...
if __name__ == "__main__":
    ...
    lost = requests.post('http://localhost:9012/message',
    ...
    damned = requests.post('http://localhost:9012/message',
    ...
    bared = requests.post('http://localhost:9012/message',
    ...
    abridged = requests.post('http://localhost:9012/message',
